...
// Custom Foreach Builder for Honey Comb Grid View
        ...
        items.forEach { item in
            ...
            if count == items.count {
                if let last = rows.last {
                    ...
                    // Checking If Previous Rows Have Vacancies
